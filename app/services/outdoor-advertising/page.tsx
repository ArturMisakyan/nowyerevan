    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="above-fold bg-overlay" style={{ "--overlay-opacity": "0.3" } as React.CSSProperties}>
        <div
          ...
          style={{ backgroundImage: "url(/images/Outdoor_ad.webp)" }}
        />
        ...
        <div className="above-fold-content">
          <div className="container mx-auto px-4">
            ...
            <nav className="flex items-center space-x-2 text-white mb-8 text-sm md:text-base">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-brand-orange">{t("outdoorAd")}</span>
            </nav>
            ...
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">{t("outdoorAd")}</h1>
              <p className="text-xl md:text-2xl mb-8 leading-relaxed opacity-90">{t("outdoorAdDesc")}</p>
