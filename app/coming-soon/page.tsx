      ...
      <div className="max-w-2xl w-full text-center relative z-10 flex flex-col items-center">
        ...
        <div className="relative inline-block mb-8 mt-8">
          <img
            ...
            alt="NOW Logo"
            className="h-20 md:h-28 w-auto mx-auto filter brightness-0 invert drop-shadow-lg"
          />
        ...
        <div className="flex justify-center mb-4">
          <Link href="/" passHref>
            <Button
              size="lg"
              className="bg-brand-orange hover:bg-brand-orange-hover text-white px-6 py-3 text-base font-bold shadow-xl hover:shadow-orange-500/25 transition transform hover:scale-105 group"
            >
