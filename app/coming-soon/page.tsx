  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-20 w-2 h-2 bg-yellow-400 rounded-full animate-pulse delay-700"></div>
      </div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        <div className="mb-8">
          <div className="relative inline-block">
            ...
            <div className="absolute -top-2 -right-2 md:-top-4 md:-right-4">
              <div className="w-4 h-4 md:w-6 md:h-6 bg-yellow-400 rounded-full animate-bounce"></div>
            </div>
          </div>
        </div>

        {/* Coming Soon Badge */}
        <div className="inline-flex items-center space-x-2 bg-yellow-400 text-black px-6 py-2 rounded-full font-bold text-sm md:text-base mb-8 animate-pulse">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
          Something{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">Amazing</span>
          <br />
          is Coming
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12 max-w-2xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-4 hover:bg-white/10 transition-all duration-300">
            <Rocket className="w-6 h-6 text-yellow-400 mx-auto mb-2" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/" passHref>
            <Button
              size="lg"
              className="bg-yellow-400 hover:bg-yellow-500 text-black px-8 py-4 text-lg font-bold shadow-xl hover:shadow-yellow-400/25 transition-all duration-300 transform hover:scale-105 group"
            >
      ...
      <div className="absolute top-1/4 left-10 animate-float">
        <div className="w-8 h-8 border-2 border-yellow-400 rounded-full opacity-20"></div>
      </div>
